...
class ZohoBooksCustomActionController
{
    private const ENDPOINT = '/settings/customactions';
    ...
    public static function get($action_id, $organization_id)
    {
        return self::request('GET', self::ENDPOINT . '/' . $action_id, $organization_id);
    }

    public static function update($action_id, $data, $organization_id)
    {
        return self::request('PUT', self::ENDPOINT . '/' . $action_id, $organization_id, $data);
    }

    public static function delete($action_id, $organization_id)
    {
        return self::request('DELETE', self::ENDPOINT . '/' . $action_id, $organization_id);
    }
