 ...
 * @method static mixed getInvoiceComments(array $data = [])
 ...
 * @method static mixed deleteAttachmentFromSalesOrder(array $data = [])
 * @method static mixed requestApprovalForSalesOrder(array $data = [])
 * @method static mixed getSalesOrderComments(array $data = [])
 ...
 * @method static array getBooksCustomFields(int $organization_id, array $query = [])
 * @method static array createBooksCustomField(array $data, int $organization_id)
 * @method static array getBooksCustomField(int $field_id, int $organization_id)
 * @method static array updateBooksCustomField(int $field_id, array $data, int $organization_id)
 * @method static array deleteBooksCustomField(int $field_id, int $organization_id)
 * @method static array getBooksWebhooks(int $organization_id, array $query = [])
 * @method static array createBooksWebhook(array $data, int $organization_id)
 * @method static array getBooksWebhook(int $webhook_id, int $organization_id)
 * @method static array updateBooksWebhook(int $webhook_id, array $data, int $organization_id)
 * @method static array deleteBooksWebhook(int $webhook_id, int $organization_id)
 * @method static array getBooksCustomFunctions(int $organization_id, array $query = [])
 * @method static array createBooksCustomFunction(array $data, int $organization_id)
 * @method static array getBooksCustomFunction(int $function_id, int $organization_id)
 * @method static array updateBooksCustomFunction(int $function_id, array $data, int $organization_id)
 * @method static array deleteBooksCustomFunction(int $function_id, int $organization_id)
 * @method static array getBooksCustomActions(int $organization_id, array $query = [])
 * @method static array createBooksCustomAction(array $data, int $organization_id)
 * @method static array getBooksCustomAction(int $action_id, int $organization_id)
 * @method static array updateBooksCustomAction(int $action_id, array $data, int $organization_id)
 * @method static array deleteBooksCustomAction(int $action_id, int $organization_id)
 ...
 * @method static mixed getAllAttachmentFromZohoBooks($data=[])
